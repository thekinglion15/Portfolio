...
const educations = [
    ...
    { logo: "harvard.png", institution: "Harvard", programs: ["CS50x", "CS50's Introduction to Programming with Python", "CS50's Introduction to Databases with SQL", "CS50's Understanding Technology"] },
    ...
    { logo: "oracle-one.png", institution: "Oracle ONE", programs: ["React G6 - ONE", "Front End G6 - ONE", "Explora React con JavaScript", "Lógica de programación con JavaScript", "Principiante en Programación G6 - ONE"] },
